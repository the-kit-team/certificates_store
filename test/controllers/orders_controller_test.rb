...
class OrdersControllerTest < ActionController::TestCase
  ...
  test "should send invoice email after creating new order" do
    ...
    assert_equal 'Thank you for chose our resource', welcome_email.subject
    assert_match /Welcome to example.com, #{@order.creator_name}/, welcome_email.text_part.body.to_s
    assert_match /<h1>Welcome to example.com, #{@order.creator_name}<\/h1>/, welcome_email.html_part.body.to_s
  end
end
